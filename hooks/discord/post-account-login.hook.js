 ...
 * 
 * This code is provided as a sample integration with Discord. Customize to fit your needs.
 * 
...
module.exports = async function({ application, oidc_context, customer, session }) {
    ...
    let hook = new discord.Webhook(DISCORD_WEBHOOK);
    const msg = new discord.MessageBuilder()
        .setName("Strivacity")
        .setTitle("User completed login")
        .addField("Application Name", application.name, true)
        .addField("User ID", customer.info.userName, true)
